    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
             <li class="menu">
                ...
                <li class="menu">
                    <a href="#dashboard" data-active="false" data-toggle="collapse" aria-expanded="true"
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="">
                            <a href="{{ route('sections.index') }}">  الاقسام الرئيسية  </a>
                        </li>
                        <li class="">
                            <a href="{{ route('subsections.index') }}">  الاقسام الفرعية </a>
                        </li>
                    </ul>
                ...
                <li class="menu">
                    <a href="#products" data-active="false" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
